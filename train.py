...
def main(argv=None):
    # Configurations
    config = Config()
    config.DATA_DIR = ['/work3/s144852/siw/SiW_M_Makeup_Ob_Binary_Files',
                       '/work3/s144852/siw/SiW_M_Mask_Silicone_Binary_Files',
                       '/work3/s144852/siw/SiW_M_Makeup_Co_Binary_Files',
                       '/work3/s144852/siw/SiW_M_Mask_Paper_Binary_Files',
                       '/work3/s144852/siw/SiW_M_Makeup_Im_Binary_Files',
